...
class LabelsControllerTest < ActionController::TestCase
  ...
  test "should create label" do
    assert_difference('Label.count') do
      post :create, label: { name: @label.name, order: @label.order, uniqueness: @label.uniqueness, white_list: @label.white_list }
    end
  ...
  test "should update label" do
    patch :update, id: @label, label: { name: @label.name, order: @label.order, uniqueness: @label.uniqueness, white_list: @label.white_list }
    assert_redirected_to label_path(assigns(:label))
  end
